...
urlpatterns = [
    ...
    path('create/', views.bootscamp_create, name='boots_create'),
    path('<int:boots_pk>/', views.bootscamp_detail, name='boots_detail'),
    path('<int:boots_pk>/delete/', views.bootscamp_delete, name='boots_delete'),
    path('<int:boots_pk>/update/', views.bootscamp_update, name='boots_update'),
    path('<int:boots_pk>/like/', views.bootscamp_like, name='boots_like'),
